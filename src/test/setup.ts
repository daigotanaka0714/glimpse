...
vi.mock("@/i18n", () => ({
  useI18n: () => ({
    ...
    t: {
      app: {
        name: "Glimpse",
        tagline: "High-speed photo checker",
        version: "Version",
      },
      common: {
        cancel: "Cancel",
      ...
      emptyState: {
        title: "Glimpse",
        description: "High-speed photo checker\nSelect a folder",
      ...
      galleryView: {
        ...
        clickMultiSelect: "Click multi",
        clickRangeSelect: "Click range",
      },
      toolbar: {
        all: "All",
        adopted: "Adopted",
      ...
      settings: {
        ...
        storage: {
          ...
          cacheDeleteWarning: "Warning",
          labelDeleteWarning: "Warning",
        ...
        about: {
          ...
          reportIssue: "Report",
          sponsor: "Sponsor",
          sponsorDescription: "Support",
          language: "Language",
          languageDescription: "Choose",
        },
      },
      feedback: {
        title: "Report",
        ...
        selectMethod: "Select",
        githubIssue: "GitHub",
        githubIssueDesc: "For devs",
        feedbackForm: "Form",
        feedbackFormDesc: "Easy",
        english: "English",
        japanese: "Japanese",
        reportInEnglish: "English",
        reportInJapanese: "Japanese",
      },
      help: {
        title: "Help",
        subtitle: "Guide",
