...
| \`${modKey}+A\` | Select all |
| \`Shift+←/→/↑/↓\` | Extend range with arrows |
| \`Shift+Home/End\` | Extend range to first/last |
| \`Shift+PageUp/PageDown\` | Extend range by page |
| \`Esc\` | Clear selection |
        `.trim(),
      },
      settings: {
...
| \`${modKey}+A\` | 全選択 |
| \`Shift+←/→/↑/↓\` | 矢印キーで範囲を拡張 |
| \`Shift+Home/End\` | 先頭/末尾まで範囲拡張 |
| \`Shift+PageUp/PageDown\` | 1ページ分範囲拡張 |
| \`Esc\` | 選択解除 |
        `.trim(),
      },
      settings: {
