...
describe("Header", () => {
  ...
  it("should call onReload when reload button clicked", () => {
    ...
    render(
      <Header {...defaultProps} folderPath="/photos" onReload={handleReload} />,
    );
  ...
  it("should not render thumbnail progress when generation is complete", () => {
    render(
      <Header
        {...defaultProps}
        thumbnailProgress={{ completed: 10, total: 10 }}
      />,
    );
  ...
  it("should call onExport when export button clicked", () => {
    ...
    render(
      <Header {...defaultProps} totalFiles={10} onExport={handleExport} />,
    );
